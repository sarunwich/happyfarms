...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>ข้อมูลสินค้าในฟาร์ม</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="../admin/home">Home</a></li>
                        <li class="breadcrumb-item active">ข้อมูลสินค้าในฟาร์ม</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                            ...
                            <tr>
                                ...
                                <td>
                                  {{-- <button type="button"
                                      ...
                                      <a class="btn btn-primary btn-sm" href="{{ route('manager.addproduct', ['id' => $farm->id]) }}">
